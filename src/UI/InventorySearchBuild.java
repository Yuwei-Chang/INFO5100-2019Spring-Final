...
public class InventorySearchBuild extends JFrame {
	/* All the variables used in InventorySearch UI */
    ...
    protected JLabel labelCategory, labelEmpty, labelYear, labelTo, labelTo2, labelMileage, labelOrLess, labelPrice, 
    				 labelLocation, labelZipcode, labelMake, labelModel, labelType, labelSeatCount, labelSortBy, labelNorthTitle;
    ...
    /* Constructor of InventorySearchBuild */
